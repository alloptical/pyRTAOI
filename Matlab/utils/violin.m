...
if isempty(find(strcmp(varargin,'plot_mean')))==0
    plotmean = varargin{find(strcmp(varargin,'plot_mean'))+1};
end
if isempty(find(strcmp(varargin,'plot_median')))==0
    plot_median = varargin{find(strcmp(varargin,'plot_median'))+1};
end
...
for i=i:size(Y,2)
    ...
    if setX == 0
        if plotmean == 1
            p(1)=plot([interp1(U(:,i),F(:,i)+i,MX(:,i)), interp1(flipud(U(:,i)),flipud(i-F(:,i)),MX(:,i)) ],[MX(:,i) MX(:,i)],'color',mc,'LineWidth',2);
        end
        if plotmedian == 1
    ...
    elseif setX == 1
        if plotmean == 1
            p(1)=plot([interp1(U(:,i),F(:,i)+i,MX(:,i))+x(i)-i, interp1(flipud(U(:,i)),flipud(i-F(:,i)),MX(:,i))+x(i)-i],[MX(:,i) MX(:,i)],...
                'color',mc,'LineWidth',2);
        end
        if plotmedian == 1
