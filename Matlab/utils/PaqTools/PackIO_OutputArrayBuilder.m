...
filename       = 'VOLTAGE_OUTPUT';                                         % filename for saved output file
exp_dur_secs   = .25;                                                      % experiment duration in seconds
stim_rate_hz   = 20;                                                       % stim rate in hz
trig_dur_msecs = 5;                                                        % trigger duration in milliseconds
sample_rate_hz = 1000;                                                     % output device sample rate in hz
jitter_msecs   = 0;                                                        % jitter, randomise stim intervals. use 0 for no jitter
