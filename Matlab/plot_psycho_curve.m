...
for v = 1:num_vars
    ...
    rightchoices(v) = numel([find(trials.stim_var == v & trials.stim_type == 1 & trials.correct == 1) find(trials.stim_var == v & trials.stim_type == 2 & trials.incorrect == 1)]);
    pc_rightchoices(v) = rightchoices(v)/numel(find(trials.stim_var == v));
end
