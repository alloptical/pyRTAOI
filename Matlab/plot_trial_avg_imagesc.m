function [traces_struct] = plot_trial_avg_imagesc(cell_struct,trial_indices,photo_ensembles,plot_cell_idx,plot_photo_types,plot_condition_types,opt,varargin)
...
num_plot_rows = numel(plot_condition_types);
    ...
    for photo_type = 1:numel(plot_photo_types)
        ...
        if ~isempty(this_trials)
            ...
            if photo_type ==1
                ...
                [sorted_plot_cell_idx,this_plot_cell_idx] = sort(this_amp,'descend');
            ...
            if photo_type == 1
                try
                    [~,mark_target_idx] =intersect(sorted_plot_cell_idx,photo_ensembles{photo_idx});
                catch
                    mark_target_idx = [];
                end
            end
...
%         colorbar('SouthOutside')
        ...
        traces_struct.(['stim_' num2str(photo_idx) plot_photo_types{photo_type}]) = this_traces;
    end
